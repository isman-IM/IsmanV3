            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Script',
                                    url: 'https://wa.me/6282237949722?text=Assalamualaikum%20Bagi%20Sc%20nya%20Kak'
                                }
                            }, {
                                callButton: {
...
➣ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                isman.sendListMsg(m.chat, `Please select the menu you want to change!`, global.author, `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Halo Kak... Lagi Cari Bot Ya\n`,
                    description: "*Klik Aja Tombol Isman*",
                    buttonText: "▪️Isman▪️",
                    footerText: "Mjir Masih Dibaca",
                    listType: "SINGLE_SELECT",
                    sections: [{
								"title": "▪️Creator IsmanOfc▪️",
								"rows": [
									{
          ...
          listType: 1
            ...
            case 'okay': { m.reply('Subrek lah Yt ISMANFF')} break
            
             case 'menu': {
            anu = `Hallo Kak... \nSalam Kenal Kak, Saya *Isman-Botz*`
            let btn = [{
                        ...
                        isman.send5ButImg(m.chat, anu, global.author, global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.kontolgeming, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.kontolgeming, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.thumb, btn)
                        } tutor = fs.readFileSync('./man/selamatdatang.mp3')
                        isman.sendMessage(m.chat, {audio: tutor, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
                        }
break       
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu1, btn, global.menu1)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu1)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu1)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu1, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu2, btn, global.menu2)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu2)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu2)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu2, btn)
                        }
                     }
            break
            case 'download': {
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu3, btn, global.menu3)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu3)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu3)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu3, btn)
                        }
                     }
            break
            case 'search': {
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu4, btn, global.menu4)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu4)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu4)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu4, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu5, btn, global.menu5)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu5)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu5)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu5, btn)
                        }
                     }
            break
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu6, btn, global.menu6)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu6)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu6)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu6, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu7, btn, global.menu7)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu7)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu7)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu7, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu8, btn, global.menu8)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu8)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu8)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu8, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu9, btn, global.menu9)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu9)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu9)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu9, btn)
                        }
                     }
            break
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu10, btn, global.menu10)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu10)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu10)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu10, btn)
                        }
                     }
            break
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu11, btn, global.menu11)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu11)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu11)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu11, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu12, btn, global.menu12)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu12)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu12)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu12, btn)
                        }
                     }
            break
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu13, btn, global.menu13)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu13)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu13)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu13, btn)
                        }
                     }
            break
            case 'heker': {
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu14, btn, global.menu14)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu14)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu14)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu14, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu15, btn, global.menu15)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu15)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu15)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu15, btn)
                        }
                     }
            break
...
└───────⭓`
                 let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu16, btn, global.menu16)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu16)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu16)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu16, btn)
                        }
                     }
            break
...
└───────⭓`
                let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        isman.send5ButImg(m.chat, anu, global.author, global.menu17, btn, global.menu17)
                        } else if (setbot.templateGif) {
                        isman.send5ButGif(m.chat, anu, global.author, global.visoka, btn, global.menu17)
                        } else if (setbot.templateVid) {
                        isman.send5ButVid(m.chat, anu, global.author, global.visoka, btn, global.menu17)
                        } else if (setbot.templateMsg) {
                        isman.send5ButMsg(m.chat, anu, global.author, btn)
                        } else if (setbot.templateLocation) {
                        isman.send5ButLoc(m.chat, anu, global.author, global.menu17, btn)
                        }
                     }
            break
